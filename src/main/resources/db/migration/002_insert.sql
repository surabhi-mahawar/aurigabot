...
insert into flow (command_type, question, index, payload) values ('/leaverequest', 'Please enter the reason for leave', 0, '{"question": "Please enter the reason for leave", "questionType": "TEXT", "choices": null, "media_url": null}');

insert into flow (command_type, question, index, payload) values ('/leaverequest', 'Please enter the from date', 1, '{"question": "Please enter the from date", "questionType": "TEXT", "choices": null, "media_url": null}');

insert into flow (command_type, question, index, payload) values ('/leaverequest', 'Please enter the to date', 2, '{"question": "Please enter the to date", "questionType": "TEXT", "choices": null, "media_url": null}');

insert into flow (command_type, question, index, payload) values ('/leaverequest', 'Please enter the leave type', 3, '{"question": "Please enter the leave type", "questionType": "TEXT", "choices": [{"key": "CL", "text": "CL"}, {"key": "PL", "text": "PL"}], "media_url": null}');
